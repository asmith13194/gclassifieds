...
class App extends Component {
  ...
  updateClassified = async (update,classified) => {
    ...
    const response = await fetch(`http://atombomb-classifieds.herokuapp.com/classifieds/${classified.id}`, {
      method: 'PATCH',
  ...
  delClassified = async (id) => {
    const response = await fetch(`http://atombomb-classifieds.herokuapp.com/classifieds/${id}`, {
      method: 'DELETE'
    })
